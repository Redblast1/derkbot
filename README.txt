...
Maybe.
The bot here is an edited and expanded version of a skeleton that is provided from https://github.com/nickoala/telepot 

However, it still could be useful to others, and if you have any feedback or contributions let me know.
 
But to really learn about the telepot module, nickoala is the best person to go to, as well as the actual page https://github.com/nickoala/telepot .
...
These are taken from the Installation section on the Telepot git page, so any other problems or questions, it may be best to go there.
